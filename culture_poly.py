...
def culture_poly(rows=1, columns=1, grass=0, bush=0, carrot=0, pumpkin=0, tree = 0, sunflower = 0, cactus = 0):
	...
	plantPattern, sunflowersPosition, seedsCarrot, seedsPumpkin, seedsSunflower = routine_plant_pattern(rows, columns, grass, bush, carrot, pumpkin, tree, sunflower, cactus)
